...
func GetContentsListFromTreePaths(ctx context.Context, repo *repo_model.Repository, gitRepo *git.Repository, refCommit *git.RefCommit, treePaths []string) (files []*api.ContentsResponse) {
	var size int64
...
func GetFilesResponseFromCommit(ctx context.Context, repo *repo_model.Repository, gitRepo *git.Repository, refCommit *git.RefCommit, treeNames []string) (*api.FilesResponse, error) {
