...
func GetContentsOrList(ctx context.Context, repo *repo_model.Repository, gitRepo *git.Repository, refCommit *git.RefCommit, opts GetContentsOrListOptions) (ret api.ContentsExtResponse, _ error) {
...
func prepareGetContentsEntry(ctx context.Context, gitRepo *git.Repository, refCommit *git.RefCommit, treePath *string) (*git.TreeEntry, error) {
...
func GetFileContents(ctx context.Context, repo *repo_model.Repository, gitRepo *git.Repository, refCommit *git.RefCommit, opts GetContentsOrListOptions) (*api.ContentsResponse, error) {
	entry, err := prepareGetContentsEntry(ctx, gitRepo, refCommit, &opts.TreePath)
	if err != nil {
		return nil, err
	}
...
func getFileContentsByEntryInternal(ctx context.Context, repo *repo_model.Repository, gitRepo *git.Repository, refCommit *git.RefCommit, entry *git.TreeEntry, opts GetContentsOrListOptions) (*api.ContentsResponse, error) {
