...
import (
	...
	"gitea.dev/backend/services/auth/source/smtp"

	_ "gitea.dev/backend/services/auth/source/db"   // register the sources (and below)
	_ "gitea.dev/backend/services/auth/source/ldap" // register the ldap source
	_ "gitea.dev/backend/services/auth/source/pam"  // register the pam source
	_ "gitea.dev/backend/services/auth/source/sspi" // register the sspi source
