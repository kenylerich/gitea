...
// shortenFilename generates a short source code filename from a full package path, eg: "gitea.dev/backend/routers/common/logger_context.go" => "common/logger_context.go"
