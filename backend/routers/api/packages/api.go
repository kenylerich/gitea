...
import (
	...
	"gitea.dev/backend/routers/api/packages/alpine"
	"gitea.dev/backend/routers/api/packages/arch"
	"gitea.dev/backend/routers/api/packages/cargo"
	"gitea.dev/backend/routers/api/packages/chef"
	"gitea.dev/backend/routers/api/packages/composer"
	"gitea.dev/backend/routers/api/packages/conan"
	"gitea.dev/backend/routers/api/packages/conda"
	"gitea.dev/backend/routers/api/packages/container"
	"gitea.dev/backend/routers/api/packages/cran"
	"gitea.dev/backend/routers/api/packages/debian"
	"gitea.dev/backend/routers/api/packages/generic"
	"gitea.dev/backend/routers/api/packages/goproxy"
	"gitea.dev/backend/routers/api/packages/helm"
	"gitea.dev/backend/routers/api/packages/maven"
	"gitea.dev/backend/routers/api/packages/npm"
	"gitea.dev/backend/routers/api/packages/nuget"
	"gitea.dev/backend/routers/api/packages/pub"
	"gitea.dev/backend/routers/api/packages/pypi"
	"gitea.dev/backend/routers/api/packages/rpm"
	"gitea.dev/backend/routers/api/packages/rubygems"
	"gitea.dev/backend/routers/api/packages/swift"
	"gitea.dev/backend/routers/api/packages/terraform"
	"gitea.dev/backend/routers/api/packages/vagrant"
