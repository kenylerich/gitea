...
func ResolveRefCommit(ctx reqctx.RequestContext, repo *repo_model.Repository, inputRef string, minCommitIDLen ...int) (_ *git.RefCommit, err error) {
	refCommit := git.RefCommit{InputRef: inputRef}
