...
import (
	...
	"gitea.dev/backend/modules/validation"
	"gitea.dev/backend/modules/web"
	"gitea.dev/backend/modules/web/middleware"
	"gitea.dev/backend/routers/api/v1/activitypub"
	"gitea.dev/backend/routers/api/v1/admin"
	"gitea.dev/backend/routers/api/v1/misc"
	"gitea.dev/backend/routers/api/v1/notify"
	"gitea.dev/backend/routers/api/v1/org"
	"gitea.dev/backend/routers/api/v1/packages"
	"gitea.dev/backend/routers/api/v1/repo"
	"gitea.dev/backend/routers/api/v1/settings"
	"gitea.dev/backend/routers/api/v1/shared"
	"gitea.dev/backend/routers/api/v1/token"
	"gitea.dev/backend/routers/api/v1/user"
	"gitea.dev/backend/routers/common"
	"gitea.dev/backend/services/actions"
	"gitea.dev/backend/services/auth"
	"gitea.dev/backend/services/context"
	"gitea.dev/backend/services/forms"

	_ "gitea.dev/backend/routers/api/v1/swagger" // for swagger generation
...
// Not sufficient for mutations โ€?use reqOrgOwnership() or reqTeamMembership() for those.
...
func Routes() *web.Router {
	...
	// redirect HEAD requests to GET if no HEAD handler is defined (RFC 9110 ยง9.3.2)
