...
import (
	...
	"gitea.dev/backend/modules/indexer/code"
	issue_indexer "gitea.dev/backend/modules/indexer/issues"
	"gitea.dev/backend/modules/indexer/stats"
