...
import (
	...
	"gitea.dev/backend/modules/auth/pam"
	...
	"gitea.dev/backend/services/auth/source/ldap"
	"gitea.dev/backend/services/auth/source/oauth2"
	pam_service "gitea.dev/backend/services/auth/source/pam"
	"gitea.dev/backend/services/auth/source/smtp"
	"gitea.dev/backend/services/auth/source/sspi"
