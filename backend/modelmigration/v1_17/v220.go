...
import (
	...
	packages_model "gitea.dev/backend/models/packages" //nolint:depguard // only consts are used
	container_module "gitea.dev/backend/modules/packages/container"

	"xorm.io/xorm/schemas"
)

func AddContainerRepositoryProperty(_ context.Context, x base.EngineMigration) (err error) {
