...
if [ ! -f go.mod ] || [ ! -d contrib/packaging/snap ]; then
...
# To debug the logic:
# * last_committed_tag=v1.26.1 last_released_tag=v1.26.0 ./contrib/packaging/snap/part-gitea-pull.sh
#   it will checkout tag v1.26.1, and build that for "stable"
# * last_committed_tag=v1.26.1 last_released_tag=v1.26.1 recent_tag=v1.27.0-dev-205 ./contrib/packaging/snap/part-gitea-pull.sh
