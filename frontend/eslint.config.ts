...
export default defineConfig([
  globalIgnores([
    'frontend/web_src/js/vendor',
    'frontend/web_src/fomantic',
    'public/assets/js',
  ]),
  {
  ...
  {
    files: ['**/*.test.ts', 'frontend/web_src/js/vitest.setup.ts'],
    ignores: ['tests/e2e/**'],
    plugins: {vitest},
  ...
  },
  {
    ...
    rules: {
      'import-x/no-extraneous-dependencies': [2, {packageDir: 'frontend'}],
    },
  },
  {
    files: ['frontend/web_src/**/*'],
